...
- [x] **READ-01**: Display transcript in clean reading view with paragraph structure, timestamps, and speaker labels
- [x] **READ-02**: Browse, filter, and sort transcript list by date, title, and topic tags
- [x] **READ-03**: Smooth scrolling on transcripts up to 87K words via virtualization
- [x] **READ-04**: Search within current transcript to find specific text

### Annotation

- [x] **ANNO-01**: Select and highlight passages in transcript text
- [x] **ANNO-02**: Highlights exist independently — module tag is optional and can be added later
- [x] **ANNO-03**: Assign at most one module per highlight
- [x] **ANNO-04**: Highlights anchored robustly so they survive minor text changes in transcripts
- [x] **ANNO-05**: Display annotation list sidebar showing all highlights in current transcript

### Module Management

- [x] **MODL-01**: Create, edit, and delete modules with name, description, and color
- [~] **MODL-02**: Pre-seed taxonomy with ~8 known modules on first setup — DEFERRED (organic creation during reading)
- [x] **MODL-03**: Quick-select modules during reading via keyboard shortcuts or fast buttons

### Analysis

- [x] **ANLY-01**: Module tracing view — browse all passages tagged with a specific module across all lectures, sorted chronologically

### Export

- [x] **EXPO-01**: Export tagged passages as markdown or CSV, organized by module
