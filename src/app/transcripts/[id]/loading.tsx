  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-900">
      <div className="mx-auto max-w-3xl px-4 py-12">
        {/* Header skeleton */}
        <div className="border-b border-gray-100 dark:border-zinc-700 pb-8 mb-8">
          <div className="h-4 w-32 bg-gray-100 dark:bg-[#252540] rounded animate-pulse" />
          <div className="mt-4 h-9 w-3/4 bg-gray-200 dark:bg-zinc-700 rounded animate-pulse" />
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-center py-12">
            ...
            <span className="ml-3 text-gray-600 dark:text-zinc-400">Loading transcript...</span>
          </div>
        </div>
      </div>
    </div>
