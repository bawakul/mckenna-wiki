...
export function TranscriptReader({ transcript, initialAnnotations = [] }: TranscriptReaderProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-900 flex">
      {/* Left Sidebar */}
      <aside className="w-80 flex-shrink-0 border-r border-gray-100 dark:border-zinc-700 h-screen overflow-y-auto sticky top-0">
        <div className="p-6">
          {/* Back link */}
          <Link
            href="/transcripts"
            className="text-sm text-gray-500 dark:text-zinc-400 hover:text-gray-700 dark:hover:text-zinc-300 inline-flex items-center gap-1"
          >
          ...
          {/* Title */}
          <h1 className="text-xl font-bold text-gray-900 dark:text-zinc-100 mt-4 leading-tight">
            {transcript.title}
          </h1>

          {/* Metadata */}
          <div className="mt-3 flex flex-wrap items-center gap-2 text-sm text-gray-500 dark:text-zinc-400">
          ...
          {transcript.location && (
            <p className="mt-1 text-sm text-gray-500 dark:text-zinc-400">{transcript.location}</p>
          )}
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {transcript.topic_tags.map((tag) => (
                <Link
                  ...
                  className="rounded-full bg-gray-100 dark:bg-zinc-800 px-2.5 py-0.5 text-xs text-gray-600 dark:text-zinc-400 hover:bg-gray-200 dark:hover:bg-zinc-700"
                >
                  {tag}
                </Link>
              ))}
          ...
          {/* Search section */}
          <div>
            <label htmlFor="transcript-search" className="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-2">
            ...
            <div className="relative">
              ...
              {query && (
                <button
                  ...
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 dark:text-zinc-500 hover:text-gray-600 dark:hover:text-zinc-400"
    ...
    <button
      ...
      className={`
        ...
        ${isActive
          ...
          : 'border-gray-100 dark:border-zinc-700 hover:border-gray-200 dark:hover:border-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-800'
        }
      `}
    >
